                ...
                <div class="newsaiige-form-group">
                    <div class="newsaiige-password-wrapper">
                        <input type="password" 
                               ...
                               required>
                        <span class="newsaiige-toggle-password" onclick="togglePasswordVisibility('new_password', this)">
                ...
                <div class="newsaiige-form-group">
                    <div class="newsaiige-password-wrapper">
                        <input type="password" 
                               ...
                               required>
                        <span class="newsaiige-toggle-password" onclick="togglePasswordVisibility('confirm_password', this)">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path class="eye-open" d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle class="eye-open" cx="12" cy="12" r="3"></circle>
                                <line class="eye-closed" x1="1" y1="1" x2="23" y2="23" style="display:none;"></line>
